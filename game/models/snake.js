class Snake extends GameObject
{
    ...
    move(speed)
    {
        let nextCoordinates = this._getDeltaForDirection(speed);
    ...
    hasBittenItsTail()
    {
        ...
        let allSegmentXCoordinates = this.allSegmentXCoordinates;
        let allSegmentYCoordinates = this.allSegmentYCoordinates;

        let tailHasBeenCannibalized =
